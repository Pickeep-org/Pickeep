...
class _AddItemState extends State<AddItem> {
  ...
  void initState() {
    ...
    descriptionController.addListener(() {
      final String text = descriptionController.text.toLowerCase();
              ...
              Row(
                  children: [
                    TextButton(
                        ...
                        child: const Text("Choose item's categories", style: TextStyle(fontSize: 18),
                        ))
                  ]),
              Wrap(
  ...
  Future<void> _navigateAndDisplaySelection(BuildContext context) async {
    ...
    setState(() {chosen_categories = chosen_categories_result;});
  }
}
