...
class _FilterState extends State<FilterScreen> {
  //late Map<String, bool> _isChecked_location;
  //late List<String>     _checked_locations;
  ...
  void initState() {
    ...
    //_isChecked_location.updateAll((name, value) => value = false);
    //_isChecked_location.forEach((name, value) => _isChecked_location[name] = false);
  }
